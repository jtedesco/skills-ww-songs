...
> [!WARNING]
> **Source**: the band's hand-drafted *Ballydoyle 2-set block* (Google Doc → Setlists), rendered in the drafted running order rather than re-solved.

> [!WARNING]
> **Substitutions**: David is out — keyboard/marimba parts are covered by Jon (piano) or omitted (*Rikki Don't Lose That Number* goes keys-straight-in), and David's backing vocals are dropped. No David-led song is scheduled, so no lead vocals are reassigned.
...
**Set 1 Music Duration**: 61:41 | **Transitions**: 7:00 | **Total**: 68:41
----------------------------------------
...
| 6 | **Don't Stop** | Fleetwood Mac | E | 119 | 3:13 | Lauren | Medium→High | ✓ | Piano starts (no segue — follows Brandy) |
| 7 | **Valerie** | Amy Winehouse | E | 106 | 3:30 | Lauren | Medium | ✓ | Bass and drums |
| 8 | **American Girl** | Tom Petty | D | 114 | 3:30 | Martin (L) | High | ✓ | Guitar hook |
| 9 | **Brown Eyed Girl** | Van Morrison | G | 120 | 3:00 | Jon (L) | Low | ✓ | Jon starts |
| 10 | **Hey Jealousy** | Gin Blossoms | D | 153 | 4:00 | Martin (J, L) | Medium | ✓ | SEGUE Jon piano, Martin to electric |
...
**Set 2 Music Duration**: 60:35 | **Transitions**: 7:30 | **Total**: 68:05
----------------------------------------
...
**5. Brandy** E · 126 — <em>Keys intro</em>

**6. Don't Stop** E · 119 — <em>Piano starts (no segue — follows Brandy)</em>

**7. Valerie** E · 106 — <em>Bass and drums</em>

**8. American Girl** D · 114 — <em>Guitar hook</em>

**9. Brown Eyed Girl** G · 120 — <em>Jon starts</em>

**10. Hey Jealousy** D · 153 — <em>SEGUE Jon piano, Martin to electric</em>

**11. Jenny (867-5309)** F#m · 136 — <em>Guitar riff. Stage banter about phone numbers</em>
