# 2026-08-22 - The Can Bar (v7)

- **Version:** v7 — supersedes v6 (`2026-08-22 The Can Bar v6.md`); *Rock This Town* in for *Baby Blue*, Set 3 rebuilt as an all-danceable closing set opening Gold on the Ceiling / Pink Pony Club / Funkytown, and the Ventura Highway caution + band-intro notes dropped
- **Gig Type:** Bar
...
| Dance Peak (danceable late in each set) | ⚠️ Partially Satisfied (Set 3 is now 100% danceable end to end; Set 2 closes on 4 danceable; Set 1 closes on *Piano Man*, kept deliberately as the singalong set closer the band asked for) |
...
| Pacing Flow | ⚠️ 2 energy drop(s): Don’t Stop Believing → Piano Man (#11→#12, SET 1); Gold on the Ceiling → Pink Pony Club (#1→#2, SET 3) |
...
| 9 | **The Chain** | Fleetwood Mac | Em | 152 | 4:30 | Lauren (J) | Medium→High |  | Drums (4 on the floor) |
| 10 | **Rikki Don't Lose That Number** | Steely Dan | D | 122 | 4:30 | Jon (L) | Medium | ✓ | Keys straight in (marimba omitted — David out) |
...
| 2 | **Pink Pony Club** | Chappell Roan | E | 130 | 4:30 | Lauren (J) | Low→Medium | ✓ | Piano (B7) intro |
