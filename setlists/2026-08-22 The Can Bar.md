...
| Vocalist Balance | ⚠️ Partially Satisfied (Everybody Wants to Rule the World and Rikki Don't Lose That Number break up two Lauren streaks in Set 1 at 3-in-a-row; but Zombie → All Right Now → The Chain → Roll with the Changes is 4 Lauren leads in a row closing Set 2 — pre-existing, not introduced by these edits) |
...
| **Rock This Town** (Stray Cats) | **Them Changes** (Buddy Miles) |
