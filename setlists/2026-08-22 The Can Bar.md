...
| Vocalist Balance | ⚠️ Partially Satisfied (Set 1 runs 4 Lauren leads: You Oughta Know → The Chain → Hook → Funkytown — accepted deliberately, The Chain has internal breaks that rest her. Set 2 peaks at 3 in a row, Keep Your Hands to Yourself → Pink Pony Club → Respect, since Lauren covers KYHTY with David out) |
...
| Absent-Member Note Check | ⚠️ 2 stale reference(s): *Ventura Highway* mentions David ("3 guitars, counted off by David"); *Rikki Don't Lose That Number* mentions David ("David starts w/ marimba (or keys straight in)") |
...
- **Wish You Were Here** (Pink Floyd) - Lead: Lauren (for David)
- **Ooh La La** (Faces) - Lead: Lauren (for David)
...
| **Second Chance** (Shinedown) | **Them Changes** (Buddy Miles) |
