...
- **Gig Type:** Bar
- **Duration:** 3 sets (53:30 / 53:59 / 52:05), ~3 hrs total
- **Missing:** David
...
| Equal Set Lengths | ✅ Satisfied (53:30 / 53:59 / 52:05 — 1:54 spread across the three sets) |
...
| Lauren Vocal Health | ⚠️ Partially Satisfied (only *American Girl* separates *You Oughta Know* (#10) from *Respect* (#12) in Set 2 — 1 non-taxing song, short of the ≥2 target; inherited from the Can Bar order, where it was the cost of pulling *Hey Jealousy* up to close the segue. Me and Bobby McGee, Zombie and Roll with the Changes all clear it) |
...
> [!WARNING]
> **Substitutions**: Same running order as the Can Bar (2026-08-22), with Debo back on bass — no sub needed. David is out: keyboard/marimba parts are covered by Jon (piano) or omitted, and no David-led song is scheduled, so no lead vocals are reassigned.
